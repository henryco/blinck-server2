package dev.tindersamurai.blinckserver.unit.auth.details;

import dev.tindersamurai.blinckserver.security.details.BlinckDetailsProfileService;
...
import dev.tindersamurai.blinckserver.util.entity.BlinckAuthorityEntity;
...
public abstract class DetailsServicesTest extends BlinckUnitTest {
	...
	public void repositoryJpaInstanceTest() {
		assert testJpaRepo.existsById(testEntity.getId());
