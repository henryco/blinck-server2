package dev.tindersamurai.blinckserver.util;
...
public final class OffsetBasedPageRequest implements Pageable, Serializable {
	...
	private OffsetBasedPageRequest(int offset, int limit, Sort.Direction direction, String... properties) {
		this(offset, limit, new Sort(direction, properties));
	}

	private OffsetBasedPageRequest(int offset, int limit) {
	...
	private OffsetBasedPageRequest previous() {
		return hasPrevious() ? new OffsetBasedPageRequest(
				((int) getOffset()) - getPageSize(), getPageSize(), getSort()) : this;
	}
